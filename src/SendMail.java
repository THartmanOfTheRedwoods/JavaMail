...
public class SendMail {
    ...
    public SendMail(String host, String port, String encryptProp) {
        this(host, port, null, null, encryptProp, false);
    }
    public SendMail(String host, String port, String userName, String password, String encryptProp, boolean doAuth) {
